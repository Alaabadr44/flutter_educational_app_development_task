...
mixin _$ServiceModel {
  ...
  String? get name => throw _privateConstructorUsedError; // bool? isActive,
...
class _$ServiceModelImpl extends _ServiceModel {
  const _$ServiceModelImpl({this.id, this.name, this.price}) : super._();
