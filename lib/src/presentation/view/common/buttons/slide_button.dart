...
class SlideButtonState extends State<SlideButton> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slideAC = AnimationController(vsync: this, duration: const Duration(milliseconds: 300))
      ..addListener(() {
        listenController();
        _slideAC.removeListener(listenController);
        if (_slideAC.isCompleted) {
  ...
  void listenController() {
    ...
    if (!isOpened && widget.onButtonOpened != null && _slideAC.value > 0.5) {
      widget.onButtonOpened?.call();
      isOpened = !isOpened;
    }

    if (widget.onButtonClosed != null && _slideAC.value == widget.initialSliderPercentage) {
        ...
        children: <Widget>[
          Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: widget.backgroundColor, borderRadius: BorderRadius.circular(_borderRadius)),
          ...
          Align(
            ...
            child: GestureDetector(
              ...
              child: SizedBox(
                height: widget.height,
                child: Align(
                  alignment: widget.slideDirection == SlideDirection.right ? Alignment.centerLeft : Alignment.centerRight,
                  child: AnimatedBuilder(
                    animation: _slideAC,
                    builder: (context, child) {
                      return FractionallySizedBox(
                        widthFactor: _slideAC.value > widget.initialSliderPercentage
                            ? _slideAC.value * 1.5
                    ...
                    child: Container(
                      decoration:
                          BoxDecoration(color: widget.slidingBarColor, borderRadius: BorderRadius.circular(_borderRadius)
