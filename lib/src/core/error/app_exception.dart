...
class AppException implements Exception {
  ...
  ErrorModel get handleError {
    ...
    if (error is AppException && error.error is DioException) {
      ...
      errorModel = ErrorModel(message: error.message);
    } else {
  ...
  Response? get response => error is DioException ? (error as DioException).response : null;

  static String getErrorMsg(String key, Response? res) {
    if (res != null && res.data != null) {
      return (res.data as Map).containsKey(key) ? res.data[key] : getErrorMessage(null);
    }
